...
ggplot(c903.mageck,aes(neg.lfc,lfc_bthin)) +
  geom_point() +
  geom_point(data = c903.mageck %>% filter(sign.05), color="red") +
...
ggplot(c903.drugz,aes(normZ,lfc_bthin)) +
  geom_point() +
  geom_point(data = c903.drugz %>% filter(sign.05), color="red") +
  geom_abline(linetype="dashed")
