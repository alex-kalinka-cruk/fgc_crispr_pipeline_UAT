...
path_v2 <- file.path(params$output_v2,"public_data","multi_SLX","1","crisprn","venetoclax_d7_vs_DMSO")

compare_all(path_v1, path_v2)

cat("Day 14:")
path_v1 <- file.path(CWD,"fastq","crisprn","venetoclax_d14_vs_DMSO")
path_v2 <- file.path(params$output_v2,"public_data","multi_SLX","1","crisprn","venetoclax_d14_vs_DMSO")
...
path_mageck <- file.path(params$output_v2,"bthin","bthin_from_combinedcounts","1","crisprn",
                         "control_vs_treatment","Treatment_vs_Control.gene_summary.txt")
...
kable(c903.mageck %>%
  ...
  summarise(specificity = 1-sum(false_pos)/sum(true_neg),
            specificity.pass = specificity > params$specificity,
            sensitivity = 1-sum(false_neg)/sum(true_pos),
            sensitivity.pass = sensitivity > params$sensitivity
            )
)
