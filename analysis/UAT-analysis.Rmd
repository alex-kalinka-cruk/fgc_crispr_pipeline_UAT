...
* Compare the counts files.
* Compare the Mageck output for Treatment vs Control.
* Compare the performance of Mageck on a dataset with a known amount of log2 fold signal added to sgRNAs that are all true negatives (see `prep_data`).
